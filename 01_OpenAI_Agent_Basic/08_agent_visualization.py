...
# %% colab={"base_uri": "https://localhost:8080/"} id="f4566c82" outputId="14263cd7-0c76-4ce7-d766-66dd94ff52c1"
# !apt-get install -y graphviz   # Colab에서 실행
# !pip install openai-agents[viz]

# %% colab={"base_uri": "https://localhost:8080/"} id="7b837f06" outputId="31148c99-4e7f-48ab-84d9-3e52c80ada1a"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 290} id="50d124f5" outputId="e5aea1af-4c96-45cb-92db-b2b043195b37"
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 416} id="efc1999e" outputId="861901b8-3325-4882-e75f-2fc43c47c25e"
korean_agent = Agent(
    name="한국어 에이전트",
...
# %% colab={"base_uri": "https://localhost:8080/", "height": 416} id="b476dc1b" outputId="d7e57928-6e4a-423c-f820-6b2427dc69fe"
@function_tool
...
# %% colab={"base_uri": "https://localhost:8080/"} id="b3a4010a" outputId="0f0695b6-6598-447c-b615-6da9003cf665"
# 파일로 저장
